...
Failure _handleError(http.Response? httpResp) {
  switch (httpResp?.statusCode) {
    ...
    case 404:
    case 503:
      if (httpResp?.contentLength != null && httpResp?.statusCode != null) {
        return Failure(httpResp?.statusCode ?? 0, httpResp?.reasonPhrase ?? "");
      } else {
