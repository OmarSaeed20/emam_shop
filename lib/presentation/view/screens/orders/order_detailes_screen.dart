            ...
            builder: (controller) {
              return Column(
                ...
                children: [
                  ...
                  const Divider(),
                  10.sH,
                  if (controller.orderData!.ordersAddressid != "0")
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextWidget(
              calculationTime(controller.orderData!.datetime!),
              fontSize: 14,
            ),
          ],
        ),
                  ...
                  children: [
                    ...
                    ...List.generate(
                      ...
                      (i) => TableRow(
                        children: [
                          TextWidget(
                            "-${translateDatabase(data[i].itemsNameAr!, data[i].itemsName!)}",
                            maxLines: 2,
                          ...
                          TextWidget(
                            "${double.parse(data[i].discountPrice!).toInt()} \$",
                            textAlign: TextAlign.center,
                            fontFamily: AppStrings.montserrat,
                            overFlow: TextOverflow.ellipsis,
                            color: AppColors.awsm,
